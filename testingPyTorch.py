...
num_epochs = 5000
optimizer = optim.Adam(model.parameters(), lr=.00001) #learning rates higher than this tend to converge to local minima after first epoch
...
#Testing
f = open("binary_testing_no_nans.txt")
f.readline()
sum_correct = 0
num_samples = 0
for line in f:
